...
class string_to_int 
{
	public static void main(String[] args) 
	{
		...
		System.out.println("100 in string"+Integer.parseInt("100"));
		System.out.println("Character array:"+Arrays.toString(c));
		System.out.println("Character array:"+String.join("_",e1));
		System.out.println("Charac+c");

		System.out.println(f+" "+f.replaceAll("a","@"));
